...
namespace MobileAPI_V2.Model
{
    public class SendSMSEcomm
    {
        ...
        public static SendSMSForEcomm sendSMSForEcomm;
        private readonly LogWrite _logwrite;
        //public SendSMSEcomm(IConfiguration configuration, IDataRepositoryEcomm dataRepository, LogWrite logwrite)
        //public SendSMSEcomm(IConfiguration configuration, IDataRepositoryEcomm dataRepository)
        public SendSMSEcomm(ConnectionString connectionString, IConfiguration configuration, IDataRepositoryEcomm dataRepository, LogWrite logwrite)
        {
        ...
        public void SendSMSMessage(string Mobile, string Message, string title = "")
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //if (sendSMSForEcomm.EQUENCE_SMS_FLAG == "1")
                    //{
                    //    sendSMSForEcomm.SendSMSMessage(Mobile, TempId, Message);
                    //}
                    //else
                    //{
                    //    SMSAPI = SMSAPI.Replace("[AND]", "&");
                    ...
                    //    HttpWebResponse httpResponse = (HttpWebResponse)(httpReq.GetResponse());
                    //}
                    SendSMSReq sendSMSReq = new()
                    {
                        to = Mobile,
                        tmplId = TempId,
                        text = Message,
                    };
                    Task<string> result = sendSMSForEcomm.SendSMSMessage(sendSMSReq);
